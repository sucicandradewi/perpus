                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Ulasan</label>
                                        <div class="col-sm-8">
                                            <input name="ulasan" type="text" id="ulasan" class="form-control" autocomplete="off" value="<?php echo $data['ulasan']; ?>" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Rating</label>
                                        <div class="col-sm-8">
                                            <input name="rating" type="number" id="rating" class="form-control" autocomplete="off" value="<?php echo $data['rating']; ?>" required />
                                        </div>
                                    </div>
